module com.salamancas.library {
	...
	opens com.salamancas.library.model.persistence.table to org.hibernate.orm.core;
	opens com.salamancas.library.model.persistence.view to org.hibernate.orm.core;
}